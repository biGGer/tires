...
use biGGer\Bundle\TireBundle\Entity\Settings;
use biGGer\Bundle\TireBundle\Form\SettingsType;
...
class SettingsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TireBundle:Settings')->findAll();
     ...
     * @Method("POST")
     * @Template("TireBundle:Settings:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TireBundle:Settings')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TireBundle:Settings:edit.html.twig")
     */
