...
use biGGer\Bundle\TireBundle\Entity\Manufacturer;
use biGGer\Bundle\TireBundle\Form\ManufacturerType;
...
class ManufacturerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TireBundle:Manufacturer')->findAll();
     ...
     *
     * @Route("/", name="manufacturer_create")
     * @Method("POST")
     * @Template("TireBundle:Manufacturer:new.html.twig")
     */
    ...
    private function createCreateForm(Manufacturer $entity)
    {
        $form = $this->createForm(new ManufacturerType(), $entity, array(
            'action' => $this->generateUrl('manufacturer_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TireBundle:Manufacturer')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new ManufacturerType(), $entity, array(
            'action' => $this->generateUrl('manufacturer_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="manufacturer_update")
     * @Method("PUT")
     * @Template("TireBundle:Manufacturer:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('manufacturer_delete', array('id' => $id)))
            ->setMethod('DELETE')
